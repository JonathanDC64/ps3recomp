...
def rrr(op4, rt, ra, rb, rc):
    # Real SPU RRR encoding (matches the disassembler):
    #   MSB->LSB: op4(4) | RT(7) | RB(7) | RA(7) | RC(7)
    return w(((op4 & 0xF) << 28) | ((rt & 0x7F) << 21) | ((rb & 0x7F) << 14)
             | ((ra & 0x7F) << 7) | (rc & 0x7F))
...
b += rrr(0xB, 6, 3, 4, 5)        # shufb r6, r3, r4, r5  (RRR opcode 0xB; 0x8 is selb)
